...
public class KTailsMerge {
    ...
    public final Alphabet<Event> alphabet;
    public NFA<Integer, Event> model;
    public KTailsMerge(NFA<Integer, Event> model, Alphabet<Event> alphabet) {
        this.model = model;
    ...
    public CompactNFA<Event> mergeLocations(int k) {
        ...
        var merged = new CompactNFA<Event>(new GrowingMapAlphabet<>());
    ...
    private Map<Integer, Integer> computeMerges(int k) {
        ...
        var maybeFutures = new HashMap<Integer, Set<List<Event>>>();
    ...
    private boolean compareLocationFutures(Set<List<Event>> locationFutures, Set<List<Event>> maybeFutureValues) {
